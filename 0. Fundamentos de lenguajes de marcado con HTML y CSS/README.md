# 🌐 FUNDAMENTOS DEL LENGUAJE DE MARCADO
...
- 🏷️ **Etiquetas**: `< p >` , `< h1 >` , `< a >` , `< img >` , etc.
- ⚙️ **Elementos**: Etiquetas de apertura `< head >` y de cierre `</ head >`.
...
## ⚖️ Importancia de HTML y CSS en el desarrollo web
...
Te la super recomiendo porque te permite ver los cambios que hagas en tiempo real al ir guardando tus avances ;D

Una vez la tengas, tan solo haz *clic derecho sobre tu archivo .html* y selecciona "`Open with live server`", y listooo! Ya no tienes que andar recargando el navegador por cada mínimo cambio que hagas x.x
...
> 💬 *Recuerda: HTML es la estructura, CSS es el alma, y tú eres the arquitecteishon que da forma a todo 💅💻*